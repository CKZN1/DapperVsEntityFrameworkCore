...
namespace DataLayer
{
    public class ContactRepository : IContactRepository
    {
        ...
        {
            string str = "Server=tcp:freeserverless.database.windows.net,1433;Initial Catalog=Free100vCoreDB;Persist Security Info=False;User ID=freesqlsa;Password=Fuckbrazil1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
